...
|           | 1일차                                                        | 2일차                                                        | 3일차                                                        | 4일차                                                        | 5일차                                          |
| --------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ---------------------------------------------- |
| Front-end | 아이디어 회의                                                | 아이디어 회의                                                | 아이디어 회의                                                |                                                              |                                                |
| Back-end  | 아이디어 회의<br />커뮤니티(CRUD) 구현<br />한국 수출입 은행 API | 아이디어 회의<br />ERD 프로토타입 제작<br />커뮤니티(CRUD) 기능 보완 | 아이디어 회의<br />금융감독원 API<br />댓글 트리(대댓글)<br />좋아요 기능<br /><br />로고 제작 | 여행 정보 데이터 제작<br />회원 프로필<br />금융상품 추천 알고리즘<br />버그 수정 | 여행-적금 통합 추천<br />버그 수정 및 리펙터링 |

|           | 6일차                                                        | 7일차 | 8일차 | 9일차 | 10일차 |
| --------- | ------------------------------------------------------------ | ----- | ----- | ----- | ------ |
| Front-end |                                                              |       |       |       |        |
| Back-end  | Readme 작성<br />새 댓글, 대댓글 알람<br/>추천 알고리즘 수정 |       |       |       |        |
