...
| ------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 강문수 | 버그수정<br />컴포넌트 구조 작성<br />알람 기능 구현         | 버그수정<br />금융/여행 추천 페이지 구현<br />컴포넌트 재정리<br />작성 페이지 보완 | 각 페이지 추가 기능 완성(알고리즘, 수정된 res데이터 반영 )<br />css 디자인 초안 | 버그 수정<br />css 1차 완성<br />구글맵 페이지 추가<br /> | css 최종 완성<br />PPT 발표준비<br />페이지 기능 점검        |
