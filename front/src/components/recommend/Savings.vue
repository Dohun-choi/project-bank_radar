...
<div class="container mt-5">
    <h2 class="title mb-3">키워드에 따른 적금 상품 추천</h2>

    <form @submit.prevent="searchSavings" class="mb-3">
    <div class="d-flex">
    ...
    <div>
    <div v-for="(recommend, index) in recomandSavings" :key="recommend.id" class="card mb-3" @click="goDetail(recommend.fin_prdt_cd)">
        <div class="card-body">
