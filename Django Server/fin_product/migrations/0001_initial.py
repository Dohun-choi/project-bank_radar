    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_limit', models.IntegerField(default='정보 없음', null=True)),
                ('spcl_cnd', models.TextField(default='알수 없음', null=True)),
                ('wish_users', models.ManyToManyField(related_name='wish_savings', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='SavingOptions',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_limit', models.IntegerField(default='정보 없음', null=True)),
                ('spcl_cnd', models.TextField(default='알수 없음', null=True)),
                ('wish_users', models.ManyToManyField(related_name='wish_deposits', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='DepositOptions',
